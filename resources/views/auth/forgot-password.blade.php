            ...
            <div class="grid lg:grid-cols-2 gap-10 items-center">
                ...
                <div class="text-white space-y-5">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-extrabold leading-tight">
                        Forgot Your Password? <br class="hidden lg:block">
                        <span class="text-blue-200">Reset it in seconds.</span>
                    </h2>

                    <p class="text-sm lg:text-base text-blue-100 max-w-xl">
                        Enter your email address, and we’ll send you a secure link to reset your password
                        and regain access to your Faculty Repository account.
                    </p>
                ...
                <div class="w-full">
                    <div class="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-white/40">
                        <h3 class="text-2xl font-bold text-gray-800 text-center mb-1">Reset Password</h3>
