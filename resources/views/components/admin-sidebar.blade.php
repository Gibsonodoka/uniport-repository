                    ...
                    <a href="{{ route('admin.dashboard') }}"
                       class="flex items-center gap-2 px-6 py-2 text-sm font-medium rounded-md transition
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 12l2-2m0 0l7-7 7 7m-9 2v8m4-8v8m4 0h2a2 2 0 002-2V10a2 2 0 00-.586-1.414l-7-7a2 2 0 00-2.828 0l-7 7A2 2 0 002 10v10a2 2 0 002 2h2" />
                        </svg>
                        Dashboard
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('admin.submissions') }}"
                       class="flex items-center gap-2 px-6 py-2 text-sm font-medium rounded-md transition
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7 8h10M7 12h8m-8 4h6M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        Submissions
                    </a>
                </li>
